...
const EducationResearch = () => {
  ...
  const [upgrades, setUpgrades] = useState(state.educationUpgrade);
  ...
  const handleUpgrade = (index) => {
   ...
   useEffect(()=>{
      dispatch({type:"EDU_UPGRADE",payload:upgrades});
    },[upgrades]);

  return (
    <div className="action-main-container">
      <div className="action-head-nav">
        <div className="action-type-name">Education & Research</div>
